...
export default class AvaTaxClient {
   ...
   * @constructor
   * @param {object} params
   * @param {string} params.appName      Specify the name of your application here.  Should not contain any semicolons.
   * @param {string} params.appVersion   Specify the version number of your application here.  Should not contain any semicolons.
   * @param {string} params.machineName  Specify the machine name of the machine on which this code is executing here.  Should not contain any semicolons.
   * @param {string} params.environment  Indicates which server to use; acceptable values are "sandbox" or "production", or the full URL of your AvaTax instance.
   */
   ...
   *
   * @param {object} params
   * @param {string} params.url      The relative path of the API on the server
   * @param {string} params.verb     The HTTP verb being used in this request
   * @param {string} params.payload  The request body, if this is being sent to a POST/PUT API call
   * @returns {any}
   */
   ...
   *
   * @param {object} params
   * @param {string} params.url         The root URL of the API being called
   * @param {object} params.parameters  A list of name-value pairs in a javascript object to create as query string parameters
   * @returns {string}
   */
   ...
   * @return FetchResult
   */
  tagTransaction({ companyId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/transactions/tag`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'put', payload: model });
  }
   ...
   * 
     ...
     * @param {number} filingCalendarId The unique ID of the filing calendar that will remove setting
     * @param {number} companyReturnSettingId The unique ID of the company return setting that will be deleted from the filing calendar
   * @return object[]
   */
   ...
   * 
     * @param {number} companyId The ID of the company that owns these batches
     * @param {number} endPeriodMonth The month of the period you are trying to retrieve
     * @param {number} endPeriodYear The year of the period you are trying to retrieve
     ...
     * @param {number} filingCalendarId The filing calendar id of the return you are trying to retrieve
